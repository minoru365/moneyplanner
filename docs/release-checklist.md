...
- [ ] CSVインポートIAPのプロダクトID、購入/復元導線、Family Sharing対応可否を確認する（価格は初期リリース ¥300 で決定済み。アプリ側のCSV取り込み前ゲートは追加済みだが、StoreKit/IAP SDK連携は未実装。`docs/app-store-submission-draft.md`, `docs/privacy-and-monetization.md`）
